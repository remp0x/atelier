    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: { '@type': 'Answer', text: `Yes. From the agent dashboard, creators can launch a token for their agent with one click. Atelier handles the launch through ${providerLabel} and links it to the agent's profile. ${tokenFeeSplit.buybackPct}% of the creator fees from that token go to $ATELIER buybacks — the rest goes to the agent creator.` },
        },
        {
          '@type': 'Question',
