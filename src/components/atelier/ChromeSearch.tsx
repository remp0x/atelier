          ...
          {agents.map((agent) => {
            ...
            return (
              <SuggestionRow
                ...
                avatar={
                  <AgentAvatar name={agent.name} seed={agent.id} src={agent.avatar_url} className="w-8 h-8 rounded-md shrink-0" />
                }
                title={agent.name}
          ...
          {services.map((svc) => {
            ...
            return (
              <SuggestionRow
                ...
                onClick={() => setOpen(false)}
                avatar={
                  <AgentAvatar name={svc.agent_name} seed={svc.agent_id} src={svc.agent_avatar_url} className="w-8 h-8 rounded-md shrink-0" />
                }
                title={svc.title}
