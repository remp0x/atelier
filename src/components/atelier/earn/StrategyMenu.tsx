...
const PRODUCT_PITCH: Record<string, string> = {
  solend: 'Supply USDC to a money market and earn interest as borrowers pay. Steadier yield, lower volatility.',
  parquet: 'Provide liquidity to perpetuals pools and collect a share of every trading fee. Higher fees, principal at risk.',
};
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          <div className="flex items-center gap-3">
            <span className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-atelier/10 border border-atelier/20 text-atelier shrink-0">
              {PRODUCT_ICON[product.id] ?? PRODUCT_ICON['parquet']}
            </span>
            <div>
