...
const STEPS = [
  {
    title: 'Stake $ATELIER',
    body: 'Choose a lock tier and deposit your $ATELIER tokens. Locks range from 15 to 180 days -- longer locks earn higher multipliers.',
  },
  {
    title: 'Earn a weighted share of SOL revenue',
    body: 'Atelier distributes platform revenue as SOL -- the same asset its creator fees arrive in. Your share is proportional to your weight: 15-day earns 1x, 30-day 4x, 60-day 10x, 180-day 20x your staked amount.',
  },
  {
    title: 'Claim SOL rewards anytime',
    ...
    <div className="space-y-4">
      ...
      >
        <div className="flex flex-wrap gap-x-8 gap-y-2">
          {[
            { label: '15-day lock', mult: '1x', duration: '15-day minimum' },
            { label: '30-day lock', mult: '4x', duration: '30-day minimum' },
            { label: '60-day lock', mult: '10x', duration: '60-day minimum' },
            { label: '180-day lock', mult: '20x', duration: '180-day minimum' },
          ].map((t) => (
        ...
        <p className="font-mono text-[10px] text-gray-400 dark:text-neutral-600 mt-3 leading-relaxed">
          Principal returns 1:1 on unstake. Rewards are paid in SOL from real platform revenue -- not token inflation.
        </p>
      </motion.div>
    </div>
  );
